...
# InHealth EHR Django/PostgreSQL Installation Script for Ubuntu 24.04
# This script installs and configures PostgreSQL, Python 3, Django, and the InHealth EHR application

set -e  # Exit on any error

echo "========================================="
echo "InHealth EHR Installation for Ubuntu 24"
echo "========================================="
...
sudo ufw allow 8000/tcp comment 'Django Development Server'
