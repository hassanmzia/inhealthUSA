...
<div class="px-4 sm:px-0">
    ...
    <div class="bg-white shadow sm:rounded-lg">
        <form method="POST" action="{{ route('patients.update', $patient->patient_id) }}" class="space-y-6 p-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <select name="gender" id="gender" required
                        ...
                        <option value="Unknown" {{ old('gender', $patient->gender) == 'Unknown' ? 'selected' : '' }}>Unknown</option>
                    </select>
                    @error('gender')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="address_street" id="address_street"
                               value="{{ old('address_street', $patient->address_street) }}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-medical-blue focus:ring-medical-blue sm:text-sm">
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <input type="text" name="address_city" id="address_city"
                                   value="{{ old('address_city', $patient->address_city) }}"
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-medical-blue focus:ring-medical-blue sm:text-sm">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="address_state" id="address_state"
                                   value="{{ old('address_state', $patient->address_state) }}"
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-medical-blue focus:ring-medical-blue sm:text-sm">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="address_zip" id="address_zip"
                                   value="{{ old('address_zip', $patient->address_zip) }}"
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-medical-blue focus:ring-medical-blue sm:text-sm">
                        </div>
                    </div>
                </div>
